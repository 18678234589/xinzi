...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($action === 'template') {
            ...
            if ($type !== '*' && (!isset(ps_business_catalog()[$type]) || !empty(ps_business_catalog()[$type]['legacy']))) throw new RuntimeException('请选择有效业务类型');
