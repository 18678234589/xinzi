...
<div class="welfare-page"><section class="welfare-hero"><div><span>RULE CENTER / ALL-TEAM BENEFITS</span><h1>全员福利池规则</h1><p>把规则讲清楚，也让每一笔结转和奖励可核对。</p></div><a class="btn btn-light" href="<?php echo BASE_URL; ?>/project/welfare.php">查看福利池 →</a></section>
 ...
 <section class="welfare-card"><h2>02 / 任期额度独立，福利池累计</h2><p>轮值董事长每届任期三个月。已确认 2026-09-15 由于洋换届为栾鑫，栾鑫本届至 2026-12-14；监委会在期满前第 7 天收到站内提醒，至少两位监委投给同一候选人后自动登记下一届。</p><p>每届董事长 ¥10,000、监委会三人合计 ¥3,000 的目标额度独立重置，不把上一届未获得额度加给下一届。每届结束并核验后，未获得额度各结转一次，持续累加到同一个全员福利池；福利池余额才是跨任期累计的。建议与 Bug 奖励按对应三个月窗口归属。系统用任期结束年份和顺序显示为 2026-Q4、2027-Q1 等；这里的“季度”不是自然季度，也不按自然季度天数拆分金额。</p></section>
