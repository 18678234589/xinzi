...
<div class="governance-page">
  ...
  <div class="governance-rule-intro"><strong>脑洞缺报按原文六天周期</strong><p>原规则写明每 6 天提交一次，连续 6 天未提交或被判无效扣 ¥300；仅在监委会登记的轮值期内、完整窗口结束后自动入账。监委会可以逐笔说明理由并豁免。原表其他条款与历史记录有出入，仍待核对；不是所有“已确认”规则都会自动扣款。</p><p><a href="<?php echo BASE_URL; ?>/project/rules.php?domain=welfare">全员福利池规则</a>自 2026-Q4 起生效：轮值董事长每季度目标 ¥10,000，监委会每人 ¥1,000（三人合计 ¥3,000）。季度核验完成后结余自动转入福利池。换届前七天提醒监委会发起投票，<a href="<?php echo BASE_URL; ?>/project/governance_election.php">打开换届投票</a>。</p></div>
