...
<div class="governance-page">
  <section class="governance-hero"><div><span class="governance-kicker">CO-CREATION / 规则中心</span><h1>管理层考核规则</h1><p>轮值董事长与监委会的规则集中在这里。原表中有待核对口径，先保留为草案；确认后供人工核验参考，不自动扣发。</p></div><span class="governance-role"><?php echo $member['governance_role'] === 'chair' ? '轮值董事长' : '监委会成员'; ?></span></section>
  <nav class="governance-tabs" aria-label="管理层栏目"><a href="<?php echo BASE_URL; ?>/project/governance.php">事项台账</a><a class="active" aria-current="page" href="<?php echo BASE_URL; ?>/project/rules.php?domain=governance">规则中心</a></nav>
  <?php if ($error): ?><div class="alert alert-danger"><?php echo e($error); ?></div><?php endif; ?>
  <?php if (isset($_GET['saved'])): ?><div class="alert alert-success">规则已更新，旧版内容保留在操作审计中。</div><?php endif; ?>
  <div class="governance-rule-intro"><strong>先确认冲突，再作为执行口径</strong><p>原表的董事长想法周期同时出现“每 3 天”“每周”和“每 6 天”，历史奖励也与文字规则不完全一致。草案不会自动生成奖惩。监委会核对并讨论后，可将逐条规则标为“已确认”；已确认也仅供核验时参考。</p></div>
