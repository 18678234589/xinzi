...
$(function() {
    ...
    $input.on('input', function() { filterOptions($(this).val()); });
    $input.on('focus', function() { if (!$dept.val() && !$(this).val()) filterOptions(''); });
